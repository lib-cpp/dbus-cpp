 ...
 */
#ifndef DBUS_ORG_FREEDESKTOP_DBUS_IMPL_GENERATOR_H_
#define DBUS_ORG_FREEDESKTOP_DBUS_IMPL_GENERATOR_H_
...
#endif // DBUS_ORG_FREEDESKTOP_DBUS_IMPL_GENERATOR_H_
